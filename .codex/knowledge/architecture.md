...
- AlarmPriority 使用 1 至 4 级警情，AlarmMethod 使用电话、设备、短信、GPS、视频、设备故障和其他报警对应的 1 至 7。AlarmType 必须与 AlarmMethod 联动：设备报警支持默认无类型及 1 至 5，视频报警支持 1 至 13（13 为 GB/T 28181-2022 图像遮挡报警），设备故障报警支持 1 至 2，其他报警方式不得携带 AlarmType。UI 使用协议字典下拉，Rust 领域层再次校验组合、AlarmStatus 和经纬度范围；默认设备报警从 XML 中省略 AlarmType。
